<template>
  <div class="client-details">
    ...
    <div class="app-wrapper">
      <el-tabs v-model="activeName" type="card" @tab-click="handleTabClick" v-loading="isLoading">
        <el-tab-pane :label="$t('Clients.basicInfo')" name="detail">
          <a-card v-if="activeName === 'detail'" class="detail-card">
            <template v-if="isThisClientExist && !isLoading">
              <el-row :gutter="40">
                <el-col :span="12">
                  <div class="emq-title">
            ...
            <template v-else-if="!isLoading && !isThisClientExist">
              <div class="no-config">
                <i class="el-icon-warning"></i>
                <span>{{ $t('Clients.clientNotExistPlaceholder') }}</span>
              </div>
            </template>
          </a-card>
        </el-tab-pane>
        <el-tab-pane :label="$t('Clients.subscriptions')" name="subscriptions">
          <a-card>
            <template v-if="activeName === 'subscriptions' && isThisClientExist">
              <div class="emq-title">
            ...
            <template v-else-if="!isThisClientExist">
              <div class="no-config">
                <i class="el-icon-warning"></i>
                <span>{{ $t('Clients.clientNotExistPlaceholder') }}</span>
              </div>
